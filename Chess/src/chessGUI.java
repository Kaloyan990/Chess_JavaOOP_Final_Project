...
public class chessGUI implements ActionListener, KeyListener, WindowFocusListener
{
	...
	public Container createGUI (JFrame mainApp)
	{
		...
		catch (NullPointerException e)
		{
			...
			JOptionPane.showMessageDialog(null, "Unable to load images. There should be a folder called " +
					"images with all the chess pieces in it. Try downloading this programme again",
